Feature: APPS/interview/68 — competitive programming problem
  Complexity: T2
  ...
  Background:
    Given the following project files:
      ...
      Print one integer — the minimum possible length of subsegment that can be changed so the resulting sequence of operations moves the robot from $(0, 0)$ to $(x, y)$. If this change is impossible, print $-
      ...(truncated)
