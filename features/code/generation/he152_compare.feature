Feature: HumanEval/152 — implement compare
  Complexity: T2
  ...
  Scenario: Agent implements compare so all tests pass
    Given an agent is tasked with implementing the compare function in solution.py so all pytest tests pass
